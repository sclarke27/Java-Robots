...
public class eb500 {
  ...
  private char[] recvbuf = new char[512];
  private StringBuffer recvbuf2 = new StringBuffer();
  ...
  */
  ...
  public int sendCommand(int command, String txt) {
	...
	messageLine4.append("Command: ");
	messageLine4.append(k);
  ...
  public void print() {
	  SerialLCD.clearScr();
	  SerialLCD.writeLine(recvbuf2.toString(), 1);
	  Format.printf("%s\n",recvbuf2.toString());
  }
